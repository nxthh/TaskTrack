...
## Usage Note
Upon first launch, you will be prompted to create an account. The first user registered can be assigned the **Admin** role to access system-wide management features.
